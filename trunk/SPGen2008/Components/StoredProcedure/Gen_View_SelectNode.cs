...
EXEC sys.sp_addextendedproperty @name=N'SPGenSettings_ResultType', @value=N'" + v.ToString() + @"' , @level0type=N'SCHEMA',@level0name=N'" + v.Schema + @"', @level1type=N'PROCEDURE',@level1name=N'usp_" + v.Name + @"_SelectNode'
